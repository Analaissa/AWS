...
Desafiamos você a descobrir como realizar essa tarefa sem uma orientação passo a passo específica. No entanto, se você precisar de orientação detalhada, selecione este texto para revelar as etapas detalhadas:
      ...
      Abra outra guia do navegador e vá para https://console.aws.amazon.com/ec2. Selecione Instâncias. Observe que existe uma instância do EC2 chamada *instance1* em um estado de execução. Na guia Details (Detalhes) da instance1, copie o ID da instância (ele começará com i-). Observação: mantenha essa guia do navegador aberta. Você retornará a ela logo mais.
